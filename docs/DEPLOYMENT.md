...
* Production đặt `DISALLOW_FILE_MODS=true` và `DISALLOW_FILE_EDIT=true`: nội dung/cấu hình cửa hàng vẫn chỉnh trong `wp-admin`, còn code/plugin/theme đi qua Composer và release artifact.
