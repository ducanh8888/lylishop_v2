        ...
        <div class="wrap">
            ...
            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                ...
                <table class="form-table" role="presentation">
                    <tr><th scope="row"><?php esc_html_e('Bật connector', 'lyli-ghn-connector'); ?></th><td><label><input type="checkbox" name="lyli_ghn[enabled]" value="1" <?php checked(! empty($settings['enabled'])); ?>> <?php esc_html_e('Cho phép thao tác vận đơn GHN trong đơn WooCommerce', 'lyli-ghn-connector'); ?></label></td></tr>
