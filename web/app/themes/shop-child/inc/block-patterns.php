    ...
    $patterns = [
        'lyli-hero' => [
            ...
            'content' => sprintf(
                ...
                . '<!-- wp:cover {"dimRatio":0,"overlayColor":"lyli-hero-soft","minHeight":520,"minHeightUnit":"px","className":"lyli-hero-visual"} --><div class="wp-block-cover lyli-hero-visual" style="min-height:520px"><span aria-hidden="true" class="wp-block-cover__background has-lyli-hero-soft-background-color has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container">'
