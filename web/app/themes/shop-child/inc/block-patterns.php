    ...
    $patterns = [
        'lyli-hero' => [
            ...
            'content' => sprintf(
                ...
                . '<div class="wp-block-columns are-vertically-aligned-center lyli-hero-grid"><!-- wp:column {"verticalAlignment":"center"} -->'
                . '<div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"className":"lyli-eyebrow"} --><p class="lyli-eyebrow">Lyli Shop · Handmade</p><!-- /wp:paragraph -->'
                . '<!-- wp:heading {"level":1} --><h1 class="wp-block-heading">Những món quà len nhỏ, mang theo cảm xúc thật</h1><!-- /wp:heading -->'
                ...
                . '<!-- wp:cover {"dimRatio":0,"overlayColor":"lyli-lavender","className":"lyli-hero-visual"} --><div class="wp-block-cover lyli-hero-visual"><span aria-hidden="true" class="wp-block-cover__background has-lyli-lavender-background-color has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container">'
        ...
        'lyli-custom-order-cta' => [
            ...
            'categories' => ['lyli-shop'],
            'content' => sprintf(
                '<!-- wp:group {"align":"wide","className":"lyli-pattern lyli-custom-cta","layout":{"type":"constrained"}} --><div class="wp-block-group alignwide lyli-pattern lyli-custom-cta"><!-- wp:columns {"verticalAlignment":"center","className":"lyli-custom-cta-grid"} --><div class="wp-block-columns are-vertically-aligned-center lyli-custom-cta-grid">'
                . '<!-- wp:column {"verticalAlignment":"center"} --><div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"className":"lyli-eyebrow"} --><p class="lyli-eyebrow">Mẫu riêng của bạn</p><!-- /wp:paragraph --><!-- wp:heading --><h2 class="wp-block-heading">Có một ý tưởng chưa thấy trong cửa hàng?</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Gửi mô tả, màu sắc hoặc hình tham khảo. Lyli Shop sẽ trao đổi lại trước khi bắt đầu.</p><!-- /wp:paragraph --></div><!-- /wp:column -->'
                . '<!-- wp:column {"verticalAlignment":"center"} --><div class="wp-block-column is-vertically-aligned-center"><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="%s">Gửi yêu cầu đặt mẫu</a></div><!-- /wp:button --></div><!-- /wp:buttons --></div><!-- /wp:column --></div><!-- /wp:columns --></div><!-- /wp:group -->',
                esc_url($custom_url)
            ),
        ],
        'lyli-brand-story' => [
            ...
            'categories' => ['lyli-shop'],
            'content' => sprintf(
                '<!-- wp:group {"align":"wide","className":"lyli-pattern lyli-story","layout":{"type":"constrained"}} --><div class="wp-block-group alignwide lyli-pattern lyli-story"><!-- wp:columns {"verticalAlignment":"center","className":"lyli-story-grid"} --><div class="wp-block-columns are-vertically-aligned-center lyli-story-grid">'
                . '<!-- wp:column {"verticalAlignment":"center","className":"lyli-story-visual"} --><div class="wp-block-column is-vertically-aligned-center lyli-story-visual"><!-- wp:paragraph {"align":"center","className":"lyli-story-mark"} --><p class="has-text-align-center lyli-story-mark">Mỗi món quà<br>có một câu chuyện</p><!-- /wp:paragraph --></div><!-- /wp:column -->'
                . '<!-- wp:column {"verticalAlignment":"center"} --><div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"className":"lyli-eyebrow"} --><p class="lyli-eyebrow">Về Lyli Shop</p><!-- /wp:paragraph --><!-- wp:heading --><h2 class="wp-block-heading">Không cần cầu kỳ để trở nên đáng nhớ</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Lyli Shop hướng đến những món đồ len có cảm giác mềm mại, gần gũi và phù hợp để trao tặng. Nội dung câu chuyện này có thể được chủ shop chỉnh sửa bất cứ lúc nào.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p><a href="%s">Đọc thêm về cửa hàng →</a></p><!-- /wp:paragraph --></div><!-- /wp:column --></div><!-- /wp:columns --></div><!-- /wp:group -->',
                esc_url($about_url)
            ),
        ],
        'lyli-final-cta' => [
